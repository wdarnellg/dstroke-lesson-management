...
@include('includes.info-box')
            ...
            <div class="row">
              <panel class="panel panel-default">
                  <a href="players" class="pull-right">Player List</a>
                  <h3>Families</h3>
              </panel>
            </div>
            ...
            <ul class="list-group">
                @foreach($users as $user)
                    <li class="list-group-item">
                       <a href="/users/{{ $user->id }}">{{ $user->familyname }}</a>
    ...
    <div class="col-md-4">
         <form role="form" action="users" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="familyname" id="familyname" placeholder="Family Name"/>
            </div>
            </div>
            <div class="row">
            <div class="form-group">
